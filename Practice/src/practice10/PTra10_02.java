...
public class PTra10_02 {
	...
	public static void main(String[] args) {
		...
		us1.userId = 101;// ★ 変数usに格納されているインスタンスのuserIdフィールドに、101を代入してください


		us1.userNm = "リゾーム太郎";// ★ 変数usに格納されているインスタンスのuserNmフィールドに、"リゾーム太郎"を代入してください


		us1.mail = "rhizome@hoge.com";// ★ 変数usに格納されているインスタンスのmailフィールドに、"rhizome@hoge.com"を代入してください


		us1.password = "1qazxcv";// ★ 変数usに格納されているインスタンスのpasswordフィールドに、"1qazxcv"を代入してください
